...
*33 data entities across 12 capabilities.*

| Data Store | Type | Accessed By |
|-----------|------|-------------|
| AWS.M2.CARDDEMO.ACCTDATA.ARRYPS | QSAM | AccountandCardInquiryServices |
| AWS.M2.CARDDEMO.ACCTDATA.IMPORT | Dataset | DataImportandExportOperations |
...
| AWS.M2.CARDDEMO.CARDXREF.IMPORT | Dataset | DataImportandExportOperations |
...
| AWS.M2.CARDDEMO.CUSTDATA.IMPORT | Dataset | DataImportandExportOperations |
...
| AWS.M2.CARDDEMO.TRANSACT.IMPORT | Dataset | DataImportandExportOperations |
